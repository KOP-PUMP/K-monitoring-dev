...
class EngineeringDetail(models.Model):
    ...
    doc_number_engineer = models.CharField(max_length=100, blank=True, null=True)
    ...
    barg = models.TextField(db_column='barG', blank=True, null=True)  # Field name made lowercase.
    env_temp = models.TextField(blank=True, null=True)
    liquid_temp = models.TextField(blank=True, null=True)
    npsha = models.TextField(db_column='NPSHa', blank=True, null=True)  # Field name made lowercase.
    cal_suction_pressure = models.TextField(blank=True, null=True)
    velocity = models.TextField(blank=True, null=True)
    bep_flow = models.TextField(db_column='BEP_flow', blank=True, null=True)  # Field name made lowercase.
    ...
    npshr_suggest = models.TextField(db_column='NPSHr_suggest', blank=True, null=True)  # Field name made lowercase.
    ...
    api_suggest = models.TextField(db_column='API_suggest', blank=True, null=True)  # Field name made lowercase.
    ...
    npshr_status = models.TextField(db_column='NPSHr_status', blank=True, null=True)  # Field name made lowercase.
