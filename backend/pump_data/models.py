...
class PumpDetailLOV(models.Model):
    ...
    pump_impeller_max_size = models.TextField(max_length=100,blank=True, null=True)
...
class PumpMaterialLOV(models.Model):
    mat_lov_id = models.UUIDField(primary_key=True, editable=False , default=uuid.uuid4)
...
class MediaLOV(models.Model):
    media_lov_id = models.UUIDField(primary_key=True, editable=False , default=uuid.uuid4)
...
class PumpDetail(models.Model):
    ...
    company_id = models.ForeignKey(CompaniesDetail, on_delete=models.SET_NULL, null=True)
    pump_lov_id = models.ForeignKey(PumpDetailLOV, on_delete=models.SET_NULL, null=True)
    media_lov_id = models.ForeignKey(MediaLOV, on_delete=models.SET_NULL, null=True)
    mat_lov_id = models.ForeignKey(PumpMaterialLOV, on_delete=models.SET_NULL, null=True)
    motor_lov_id = models.ForeignKey(MotorDetailLOV, on_delete=models.SET_NULL, null=True)
    shaft_seal_lov_id = models.ForeignKey(ShaftSealLOV, on_delete=models.SET_NULL, null=True)

    company_code = models.TextField(max_length=100, blank=True, null = True)
    customer_industry_group = models.TextField(max_length=100, blank=True, null = True)
    company_name_en = models.TextField(max_length=100, blank=True, null = True)
    address_en = models.TextField(max_length=100, blank=True, null = True)
    company_name_th = models.TextField(max_length=100, blank=True, null = True)
    address_th = models.TextField(max_length=100, blank=True, null = True)
    map = models.TextField(max_length=100, blank=True, null = True)
    province = models.TextField(max_length=100, blank=True, null = True)
    sales_area = models.TextField(max_length=100, blank=True, null = True)
    ...
    seal_cham = models.TextField(max_length=100, blank=True, null = True)
    mechanical_seal_api_plan = models.TextField(max_length=100, blank=True, null = True)
    ...
    def __str__(self):
        return f"{self.pump_model} {self.pump_brand} {self.company_code} "
