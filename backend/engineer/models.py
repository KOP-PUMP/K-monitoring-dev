...
class EngineerReportCheckCal(models.Model):
    ...
    hyd_power_meassure = models.TextField(max_length=10, blank=True, null=True)
    head_ope = models.TextField(max_length=10, blank=True, null=True)
    hyd_power_meassure_unit = models.TextField(max_length=10, blank=True, null=True)
...
class EngineerReportCheckVisual(models.Model):
    ...
    noise_check = models.TextField(max_length=50, blank=True, null=True)
