...
export default function PumpList({ editId }: { editId?: string } = {}) {
  ...
  const [pumpImagePreview, setPumpImagePreview] = useState<string | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    const toDateOnly = (val: string | null | undefined) => {
      if (!val) return "";
    ...
    formPumpGeneralDetail.reset({
      ...
      address_th: d.address_th ?? "",
      map: d.map ?? "",
      province: d.province ?? "",
      sales_area: d.sales_area ?? "",
      doc_customer: d.doc_customer ?? "",
      doc_no: d.doc_no ?? "",
      doc_date: d.doc_date ?? "",
      tag_no: d.tag_no ?? "",
      serial_no: d.serial_no ?? "",
      pump_lov_id: d.pump_lov_id ?? "",
      pump_code_name: d.pump_code_name ?? "",
      pump_brand: d.pump_brand ?? "",
      pump_model: d.pump_model ?? "",
      pump_model_size: d.pump_model_size ?? "",
      pump_design: d.pump_design ?? "",
      pump_standard: d.pump_standard ?? "",
      pump_standard_no: d.pump_standard_no ?? "",
      pump_flange_con_std: d.pump_flange_con_std ?? "",
      pump_type_name: d.pump_type_name ?? "",
      pump_stage: d.pump_stage ?? "",
      pump_seal_chamber: d.pump_seal_chamber ?? "",
      pump_oil_seal: d.pump_oil_seal ?? "",
      pump_max_temp: d.pump_max_temp ?? "",
      pump_suction_size_id: d.pump_suction_size_id ?? "",
      pump_suction_size: d.pump_suction_size ?? "",
      pump_suction_rating: d.pump_suction_rating ?? "",
      pump_discharge_size_id: d.pump_discharge_size_id ?? "",
      pump_discharge_size: d.pump_discharge_size ?? "",
      pump_discharge_rating: d.pump_discharge_rating ?? "",
      pump_impeller_max_size: d.pump_impeller_max_size ?? "",
      pump_impeller_type: d.pump_impeller_type ?? "",
      base_plate_id: d.base_plate_id ?? "",
      base_plate: d.base_plate ?? "",
      location: d.location ?? "",
      pump_status: d.pump_status ?? "",
      design_impeller_dia: d.design_impeller_dia ?? "",
      max_temp: d.max_temp ?? "",
      pump_speed: d.pump_speed ?? "",
      pump_speed_unit: d.pump_speed_unit ?? "",
      min_flow: d.min_flow ?? "",
      min_flow_unit: d.min_flow_unit ?? "",
      design_flow: d.design_flow ?? "",
      design_flow_unit: d.design_flow_unit ?? "",
      max_flow: d.max_flow ?? "",
      max_flow_unit: d.max_flow_unit ?? "",
      bep_flow: d.bep_flow ?? "",
      bep_flow_unit: d.bep_flow_unit ?? "",
      shut_off_head: d.shut_off_head ?? "",
      shut_off_head_unit: d.shut_off_head_unit ?? "",
      min_head: d.min_head ?? "",
      min_head_unit: d.min_head_unit ?? "",
      design_head: d.design_head ?? "",
      design_head_unit: d.design_head_unit ?? "",
      max_head: d.max_head ?? "",
      max_head_unit: d.max_head_unit ?? "",
      bep_head: d.bep_head ?? "",
      bep_head_unit: d.bep_head_unit ?? "",
      npshr: d.npshr ?? "",
      npshr_unit: d.npshr_unit ?? "",
      pump_efficiency: d.pump_efficiency ?? "",
      pump_efficiency_unit: d.pump_efficiency_unit ?? "",
      hyd_power: d.hyd_power ?? "",
      hyd_power_unit: d.hyd_power_unit ?? "",
      power_min_flow: d.power_min_flow ?? "",
      power_min_flow_unit: d.power_min_flow_unit ?? "",
      power_required_cal: d.power_required_cal ?? "",
      power_required_cal_unit: d.power_required_cal_unit ?? "",
      power_max_flow: d.power_max_flow ?? "",
      power_max_flow_unit: d.power_max_flow_unit ?? "",
      power_bep_flow: d.power_bep_flow ?? "",
      power_bep_flow_unit: d.power_bep_flow_unit ?? "",
      media_lov_id: d.media_lov_id ?? "",
      media_name: d.media_name ?? "",
      media_density: d.media_density ?? "",
      media_density_unit: d.media_density_unit ?? "",
      media_viscosity: d.media_viscosity ?? "",
      media_viscosity_unit: d.media_viscosity_unit ?? "",
      media_concentration_percentage: d.media_concentration_percentage ?? "",
      operating_temperature: d.operating_temperature ?? "",
      vapor_pressure: d.vapor_pressure ?? "",
      vapor_pressure_unit: d.vapor_pressure_unit ?? "",
      solid_type: d.solid_type ?? "",
      solid_diameter: d.solid_diameter ?? "",
      solid_percentage: d.solid_percentage ?? "",
    });
    formMaterialDetail.reset({
      mat_lov_id: d.mat_lov_id ?? "",
      mat_code_name: d.mat_code_name ?? "",
      pump_type_mat: d.pump_type_mat ?? "",
      pump_mat_code: d.pump_mat_code ?? "",
      casing_mat: d.casing_mat ?? "",
      casing_cover_mat: d.casing_cover_mat ?? "",
      impeller_mat: d.impeller_mat ?? "",
      liner_mat: d.liner_mat ?? "",
      pump_base_mat: d.pump_base_mat ?? "",
      pump_head_mat: d.pump_head_mat ?? "",
    ...
    formMotorAndCouplingDetail.reset({
      motor_lov_id: d.motor_lov_id ?? "",
      motor_code_name: d.motor_code_name ?? "",
      motor_model: d.motor_model ?? "",
      motor_brand: d.motor_brand ?? "",
      motor_drive: d.motor_drive ?? "",
      motor_standard: d.motor_standard ?? "",
      motor_ie: d.motor_ie ?? "",
      motor_speed: d.motor_speed ?? "",
      motor_speed_unit: d.motor_speed_unit ?? "",
      motor_rated: d.motor_rated ?? "",
      motor_rated_unit: d.motor_rated_unit ?? "",
      motor_factor: d.motor_factor ?? "",
      motor_connection: d.motor_connection ?? "",
      motor_phase: d.motor_phase ?? "",
      motor_efficiency: d.motor_efficiency ?? "",
      motor_efficiency_unit: d.motor_efficiency_unit ?? "",
      motor_rated_current: d.motor_rated_current ?? "",
      motor_rated_current_unit: d.motor_rated_current_unit ?? "",
      motor_serial_no: d.motor_serial_no ?? "",
      voltage: d.voltage ?? "",
      voltage_unit: d.voltage_unit ?? "",
      suggest_motor: d.suggest_motor ?? "",
      coup_type: d.coup_type ?? "",
    });
    formMechanicalSealDetail.reset({
      shaft_seal_lov_id: d.shaft_seal_lov_id ?? "",
      shaft_seal_code_name: d.shaft_seal_code_name ?? "",
      shaft_seal_design: d.shaft_seal_design ?? "",
      shaft_seal_brand: d.shaft_seal_brand ?? "",
      shaft_seal_model: d.shaft_seal_model ?? "",
      shaft_seal_material: d.shaft_seal_material ?? "",
      mech_size: d.mech_size ?? "",
      mech_size_unit: d.mech_size_unit ?? "",
      seal_cham: d.seal_cham ?? "",
      mechanical_seal_api_plan: d.mechanical_seal_api_plan ?? "",
      mech_main_pre: d.mech_main_pre ?? "",
      mech_main_pre_unit: d.mech_main_pre_unit ?? "",
      mech_main_temp: d.mech_main_temp ?? "",
    });
    formFlangeAndBearingDetail.reset({
      bearing_nde_one: d.bearing_nde_one ?? "",
      bearing_nde_two: d.bearing_nde_two ?? "",
      bearing_de_one: d.bearing_de_one ?? "",
      bearing_de_two: d.bearing_de_two ?? "",
      bearing_lubric_type: d.bearing_lubric_type ?? "",
      bearing_lubric_brand: d.bearing_lubric_brand ?? "",
      bearing_lubric_no: d.bearing_lubric_no ?? "",
      oil_seal: d.oil_seal ?? "",
      rotation_de: d.rotation_de ?? "",
      bearing_last_chg_dt: toDateOnly(d.bearing_last_chg_dt),
      tank_position: d.tank_position ?? "",
      tank_design: d.tank_design ?? "",
      tank_pressure: d.tank_pressure ?? "",
      flang_con_std: d.flang_con_std ?? "",
      pump_suction_rating: d.pump_suction_rating ?? "",
      pump_suction_size: d.pump_suction_size ?? "",
      suction_pipe_id: d.suction_pipe_id ?? "",
      suction_pipe_id_unit: d.suction_pipe_id_unit ?? "",
      suction_pipe_sch: d.suction_pipe_sch ?? "",
      suction_pipe_size: d.suction_pipe_size ?? "",
      suction_pipe_length: d.suction_pipe_length ?? "",
      suction_pipe_length_unit: d.suction_pipe_length_unit ?? "",
      suction_elbow: d.suction_elbow ?? "",
      suction_tee: d.suction_tee ?? "",
      suction_reducer: d.suction_reducer ?? "",
      suction_valve: d.suction_valve ?? "",
      suction_y_strainer: d.suction_y_strainer ?? "",
      suction_other: d.suction_other ?? "",
      suction_equi_length: d.suction_equi_length ?? "",
      suction_head: d.suction_head ?? "",
      suction_head_unit: d.suction_head_unit ?? "",
      suction_velo: d.suction_velo ?? "",
      suction_velo_unit: d.suction_velo_unit ?? "",
      pump_discharge_rating: d.pump_discharge_rating ?? "",
      pump_discharge_size: d.pump_discharge_size ?? "",
      discharge_pipe_sch: d.discharge_pipe_sch ?? "",
      discharge_pipe_size: d.discharge_pipe_size ?? "",
      discharge_pipe_id: d.discharge_pipe_id ?? "",
      discharge_pipe_id_unit: d.discharge_pipe_id_unit ?? "",
      discharge_pipe_length_h: d.discharge_pipe_length_h ?? "",
      discharge_pipe_length_h_unit: d.discharge_pipe_length_h_unit ?? "",
      discharge_pipe_length_v: d.discharge_pipe_length_v ?? "",
      discharge_pipe_length_v_unit: d.discharge_pipe_length_v_unit ?? "",
      discharge_elbow: d.discharge_elbow ?? "",
      discharge_tee: d.discharge_tee ?? "",
      discharge_reducer: d.discharge_reducer ?? "",
      discharge_valve: d.discharge_valve ?? "",
      discharge_y_strainer: d.discharge_y_strainer ?? "",
      discharge_other: d.discharge_other ?? "",
      discharge_equi_length: d.discharge_equi_length ?? "",
      discharge_head: d.discharge_head ?? "",
      discharge_velo: d.discharge_velo ?? "",
      discharge_velo_unit: d.discharge_velo_unit ?? "",
    });
  }, [existingPumpData]);
  ...
  const uploadImageMutation = useUploadPumpImage();
  ...
  const handleDataSubmit = () => {
    ...
    if (isEditMode && editId) {
      if (pumpImageFile) {
        uploadImageMutation.mutate({ id: editId, file: pumpImageFile });
      }
      ...
      createMutation.mutate(
        ...
        },
        {
          onSuccess: (response: any) => {
            if (pumpImageFile && response?.pump_id) {
              ...
              <form>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="text-foreground dark:text-foreground grow flex-1">
                    <FormBox
                      field="Pump Image"
                      description="Upload a real photo of this pump (optional)."
                    >
                      <div className="space-y-2">
                        {(pumpImagePreview || existingPumpData?.pump_image) && (
                          <img
                            src={
                              pumpImagePreview ||
                              existingPumpData?.pump_image
                            }
                            alt="Pump"
                              ...
                              <div className="flex items-center">
                                ...
                                <FormControl className="w-full">
                                  <Input
                                    ...
                                    {...field}
                                    defaultValue={
                                      getFormData("formData1").solid_percentage
                                        ? getFormData("formData1")
                                            .solid_percentage
                                        : ""
                                    }
                                ...
                                <div className="w-full flex gap-2">
                                    ...
                                    render={({ field: Field }) => (
                                      <FormControl className="w-full">
                                        <Input
                                          ...
                                          {...Field}
                                          defaultValue={
                                            getFormData("formData1").pump_speed
                                              ? getFormData("formData1")
                                                  .pump_speed
                                              : ""
                                          }
                                  ...
                                  <FormControl className="md:max-w-[500px]">
                                    <Combobox
                                      ...
                                      label={
                                        getFormData("formData1").pump_speed_unit
                                          ? getFormData("formData1")
                                              .pump_speed_unit
                                          : "Select"
                                      }
                                    ...
                                    render={({ field: Field }) => (
                                      <FormControl className="w-full">
                                        <Input
                                          ...
                                          {...Field}
                                          defaultValue={
                                            getFormData("formData1").design_flow
                                              ? getFormData("formData1")
                                                  .design_flow
                                              : ""
                                          }
                                    ...
                                    render={({ field: headField }) => (
                                      <FormControl className="w-full">
                                        <Input
                                          ...
                                          {...headField}
                                          defaultValue={
                                            getFormData("formData1").design_head
                                              ? getFormData("formData1")
                                                  .design_head
                                              : ""
                                          }
                                ...
                                <div className="w-full flex gap-2">
                                  <FormControl>
                                    <Input
                                      ...
                                      readOnly
                                      defaultValue={
                                        getFormData("formData3").motor_code_name
                                      ...
                                      <div className="py-6">
                                        <Input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            setSearchKey({
                                              ...searchKey,
                                              pump_motor_search: e.target.value,
                                            });
                                    ...
                                    render={({ field: Field }) => (
                                      <FormControl className="w-full">
                                        <Input
                                          ...
                                          readOnly
                                          defaultValue={
                                            getFormData("formData3").motor_speed
                                              ? getFormData("formData3")
                                                  .motor_speed
                                              : ""
                                          }
                                    ...
                                    render={({ field: motorRateField }) => (
                                      <FormControl className="w-full">
                                        <Input
                                          ...
                                          readOnly
                                          defaultValue={
                                            getFormData("formData3").motor_rated
                                              ? getFormData("formData3")
                                                  .motor_rated
                                              : ""
                                          }
                              ...
                              <div className="flex items-center">
                                ...
                                <FormControl className="w-full">
                                  <Input
                                    ...
                                    readOnly
                                    defaultValue={
                                      getFormData("formData3").motor_connection
                                        ? getFormData("formData3")
                                            .motor_connection
                                        : ""
                                    }
                                      ...
                                      <div className="py-6">
                                        <Input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            setPumpShaftSealLOVData(filterData);
                                          }}
                                        />
                                        <div className="space-y-4 h-[400px] max-h-[400px] overflow-y-auto">
                              ...
                              <div className="flex items-center">
                                ...
                                <FormControl className="w-full">
                                  <Input
                                    ...
                                    readOnly
                                    defaultValue={
                                      getFormData("formData4").shaft_seal_design
                                        ? getFormData("formData4")
                                            .shaft_seal_design
                                        : ""
                                    }
                              ...
                              <div className="flex items-center">
                                ...
                                <FormControl className="w-full">
                                  <Input
                                    ...
                                    readOnly
                                    defaultValue={
                                      getFormData("formData4").shaft_seal_brand
                                        ? getFormData("formData4")
                                            .shaft_seal_brand
                                        : ""
                                    }
                              ...
                              <div className="flex items-center">
                                ...
                                <FormControl className="w-full">
                                  <Input
                                    ...
                                    readOnly
                                    defaultValue={
                                      getFormData("formData4").shaft_seal_model
                                        ? getFormData("formData4")
                                            .shaft_seal_model
                                        : ""
                                    }
                              ...
                              <div className="flex items-center">
                                ...
                                <FormControl className="w-full">
                                  <Combobox
                                    ...
                                    label={
                                      getFormData("formData5").pump_suction_size
                                        ? getFormData("formData5")
                                            .pump_suction_size
                                        : formFlangeAndBearingDetail.getValues(
                                              "pump_suction_size",
                              ...
                              <div className="flex items-center">
                                ...
                                <FormControl className="w-full">
                                  <Combobox
                                    ...
                                    label={
                                      getFormData("formData5").suction_pipe_sch
                                        ? getFormData("formData5")
                                            .suction_pipe_sch
                                        : formFlangeAndBearingDetail.getValues(
                                              "suction_pipe_sch",
                              ...
                              <div className="flex items-center">
                                ...
                                <FormControl className="w-full">
                                  <Combobox
                                    ...
                                    label={
                                      getFormData("formData5").suction_pipe_size
                                        ? getFormData("formData5")
                                            .suction_pipe_size
                                        : "Select"
                                    }
                              ...
                              <div className="flex items-center">
                                ...
                                <FormControl className="w-full">
                                  <Combobox
                                    ...
                                    label={
                                      getFormData("formData5").bearing_lubric_no
                                        ? getFormData("formData5")
                                            .bearing_lubric_no
                                        : formFlangeAndBearingDetail.getValues(
                                              "bearing_lubric_no",
