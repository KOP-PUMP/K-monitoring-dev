...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "tw-group/field-label tw-peer/field-label tw-flex tw-w-fit tw-gap-2 tw-leading-snug group-data-[disabled=true]/field:tw-opacity-50",
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "tw-flex tw-w-fit tw-items-center tw-gap-2 tw-text-sm tw-font-medium tw-leading-snug group-data-[disabled=true]/field:tw-opacity-50",
        className
      )}
      {...props}
    />
