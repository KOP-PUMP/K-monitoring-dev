  ...
  return (
    <div className="flex-1 space-y-4 px-4 sm:p-8 sm:pt-6">
      <div className="flex items-center justify-between">
        ...
        <Link to="/pump/pump_detail_edit" search={{ id: id ?? "" }}>
            ...
            {pumpDetail ? (
              <CardContent className="flex flex-col gap-2 text-sm">
                ...
                <div className="flex gap-2">
                  ...
                  <Input
                    id="pump_type_name"
                    value={pumpDetail?.pump_type_name ?? ""}
                    className="h-6"
                    readOnly
                  />
                </div>
                <div className="flex gap-2">
                  ...
                  <Input
                    id="pump_standard"
                    value={pumpDetail?.pump_standard ?? ""}
                    className="h-6"
                    readOnly
                  />
                </div>
              ...
              <CardContent className="flex flex-col gap-2 text-sm">
                ...
                <div className="flex gap-2">
                  <label htmlFor="suction_velo" className="w-[200px]">
                    Suction Velocity{" "}
                    {pumpDetail?.suction_velo_unit
                      ? `(${pumpDetail.suction_velo_unit})`
                      : ""}
                  </label>
                  <Input
                    id="suction_velo"
                    value={pumpDetail?.suction_velo ?? ""}
                    className="h-6"
                    readOnly
                  />
                </div>
                <div className="flex gap-2">
                  <label htmlFor="discharge_velo" className="w-[200px]">
                    Discharge Velocity{" "}
                    {pumpDetail?.discharge_velo_unit
                      ? `(${pumpDetail.discharge_velo_unit})`
                      : ""}
                  </label>
                  <Input
                    id="discharge_velo"
                    value={pumpDetail?.discharge_velo ?? ""}
                    className="h-6"
                    readOnly
                  />
                </div>
                ...
                <div className="flex gap-2">
                  <label htmlFor="bep_flow" className="w-[200px]">
                    Flow Best Efficiency Point{" "}
                    {pumpDetail?.bep_flow_unit
                      ? `(${pumpDetail.bep_flow_unit})`
                      : ""}
                  </label>
                  <Input
                    id="bep_flow"
                    value={pumpDetail?.bep_flow ?? ""}
                    className="h-6"
                    readOnly
                  />
                </div>
                <div className="flex gap-2">
                  <label htmlFor="npshr" className="w-[200px]">
                    NPSHr{" "}
                    {pumpDetail?.npshr_unit ? `(${pumpDetail.npshr_unit})` : ""}
                  </label>
                  <Input
                    id="npshr"
                ...
                <div className="flex gap-2">
                  <label htmlFor="pump_efficiency" className="w-[200px]">
                    Pump Efficiency{" "}
                    {pumpDetail?.pump_efficiency_unit
                      ? `(${pumpDetail.pump_efficiency_unit})`
                      : ""}
                  </label>
                  <Input
                ...
                <div className="flex gap-2">
                  <label htmlFor="power_required_cal" className="w-[200px]">
                    Power Required{" "}
                    {pumpDetail?.power_required_cal_unit
                      ? `(${pumpDetail.power_required_cal_unit})`
                      : ""}
                  </label>
                  <Input
                ...
                <div className="flex gap-2">
                  <label htmlFor="power_min_flow" className="w-[200px]">
                    Power Min{" "}
                    {pumpDetail?.power_min_flow_unit
                      ? `(${pumpDetail.power_min_flow_unit})`
                      : ""}
                  </label>
                  <Input
                ...
                <div className="flex gap-2">
                  <label htmlFor="power_max_flow" className="w-[200px]">
                    Power Max{" "}
                    {pumpDetail?.power_max_flow_unit
                      ? `(${pumpDetail.power_max_flow_unit})`
                      : ""}
                  </label>
                  <Input
                ...
                <div className="flex gap-2">
                  <label htmlFor="power_bep_flow" className="w-[200px]">
                    Power Best Efficiency Point{" "}
                    {pumpDetail?.power_bep_flow_unit
                      ? `(${pumpDetail.power_bep_flow_unit})`
                      : ""}
                  </label>
                  <Input
                    id="power_bep_flow"
                    value={pumpDetail?.power_bep_flow ?? ""}
                    className="h-6"
                    readOnly
                  />
                </div>
      ...
      <Card className="w-full">
        <Collapsible>
          ...
          <CollapsibleContent>
            <CardContent className="flex flex-col gap-2 text-sm">
              <div className="flex gap-2">
                <label htmlFor="media_name" className="w-[200px]">
                  Media
                </label>
                <Input
                  id="media_name"
                  value={pumpDetail?.media_name ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="operating_temperature" className="w-[200px]">
                  Operation Temperature (°C)
                </label>
                <Input
                  id="operating_temperature"
                  value={pumpDetail?.operating_temperature ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  id="solid_diameter"
                  value={pumpDetail?.solid_diameter ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="media_density" className="w-[200px]">
                  Density{" "}
                  {pumpDetail?.media_density_unit
                    ? `(${pumpDetail.media_density_unit})`
                    : ""}
                </label>
                <Input
                  id="media_density"
                  value={pumpDetail?.media_density ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="media_viscosity" className="w-[200px]">
                  Viscosity{" "}
                  {pumpDetail?.media_viscosity_unit
                    ? `(${pumpDetail.media_viscosity_unit})`
                    : ""}
                </label>
                <Input
                  id="media_viscosity"
                  value={pumpDetail?.media_viscosity ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="vapor_pressure" className="w-[200px]">
                  Vapor Pressure{" "}
                  {pumpDetail?.vapor_pressure_unit
                    ? `(${pumpDetail.vapor_pressure_unit})`
                    : ""}
                </label>
                <Input
                  id="vapor_pressure"
                  value={pumpDetail?.vapor_pressure ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  id="tank_position"
                  value={pumpDetail?.tank_position ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  id="tank_pressure"
                  value={pumpDetail?.tank_pressure ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="suction_head" className="w-[200px]">
                  Suction Head{" "}
                  {pumpDetail?.suction_head_unit
                    ? `(${pumpDetail.suction_head_unit})`
                    : ""}
                </label>
                <Input
                  id="suction_head"
                  value={pumpDetail?.suction_head ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label
                  htmlFor="media_concentration_percentage"
                  className="w-[200px]"
                >
                  Concentration (%)
                </label>
                <Input
                  id="media_concentration_percentage"
                  value={pumpDetail?.media_concentration_percentage ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  id="solid_percentage"
                  value={pumpDetail?.solid_percentage ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
            ...
            <CardContent className="flex flex-col gap-2 text-sm">
              <div className="flex gap-2">
                <label htmlFor="voltage" className="w-[200px]">
                  Voltage{" "}
                  {pumpDetail?.voltage_unit
                    ? `(${pumpDetail.voltage_unit})`
                    : ""}
                </label>
                <Input
                  id="voltage"
                  value={pumpDetail?.voltage ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  id="suggest_motor"
                  value={pumpDetail?.suggest_motor ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  id="motor_serial_no"
                  value={pumpDetail?.motor_serial_no ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  id="motor_standard"
                  value={pumpDetail?.motor_standard ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                <label htmlFor="motor_speed" className="w-[200px]">
                  Motor Speed{" "}
                  {pumpDetail?.motor_speed_unit
                    ? `(${pumpDetail.motor_speed_unit})`
                    : ""}
                </label>
                <Input
                  id="motor_speed"
                  value={pumpDetail?.motor_speed ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="motor_rated" className="w-[200px]">
                  Motor Rated{" "}
                  {pumpDetail?.motor_rated_unit
                    ? `(${pumpDetail.motor_rated_unit})`
                    : ""}
                </label>
                <Input
                  id="motor_rated"
                  value={pumpDetail?.motor_rated ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  id="motor_connection"
                  value={pumpDetail?.motor_connection ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                <label htmlFor="motor_efficiency" className="w-[200px]">
                  Motor Efficiency{" "}
                  {pumpDetail?.motor_efficiency_unit
                    ? `(${pumpDetail.motor_efficiency_unit})`
                    : ""}
                </label>
                <Input
                  id="motor_efficiency"
                  value={pumpDetail?.motor_efficiency ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="motor_rated_current" className="w-[200px]">
                  Motor Rated Current{" "}
                  {pumpDetail?.motor_rated_current_unit
                    ? `(${pumpDetail.motor_rated_current_unit})`
                    : ""}
                </label>
                <Input
                  id="motor_rated_current"
                  value={pumpDetail?.motor_rated_current ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
          ...
          <CollapsibleContent>
            <CardContent className="flex flex-col gap-2 text-sm">
              ...
              <div className="flex gap-2">
                ...
                <Input
                  id="casing_cover_mat"
                  value={pumpDetail?.casing_cover_mat ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="liner_mat" className="w-[200px]">
                  Liner Material
                </label>
                <Input
                  id="liner_mat"
                  value={pumpDetail?.liner_mat ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="pump_impeller_type" className="w-[200px]">
                  Impeller Type
                </label>
                <Input
                  id="pump_impeller_type"
                  value={pumpDetail?.pump_impeller_type ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.design_impeller_dia ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="pump_impeller_max_size" className="w-[200px]">
                  Max Impeller Diameter (mm)
                </label>
                <Input
                  id="pump_impeller_max_size"
                  value={pumpDetail?.pump_impeller_max_size ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  id="impeller_mat"
                  value={pumpDetail?.impeller_mat ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="pump_base_mat" className="w-[200px]">
                  Base Material
                </label>
                <Input
                  id="pump_base_mat"
                  value={pumpDetail?.pump_base_mat ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="pump_head_mat" className="w-[200px]">
                  Head Material
                </label>
                <Input
                  id="pump_head_mat"
                  value={pumpDetail?.pump_head_mat ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="pump_head_cover_mat" className="w-[200px]">
                  Head Cover Material
                </label>
                <Input
                  id="pump_head_cover_mat"
                  value={pumpDetail?.pump_head_cover_mat ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label
                  htmlFor="stage_casing_diffuser_mat"
                  className="w-[200px]"
                >
                  Stage Casing / Diffuser Material
                </label>
                <Input
                  id="stage_casing_diffuser_mat"
                  value={pumpDetail?.stage_casing_diffuser_mat ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
      ...
      <Card className="w-full">
        <Collapsible>
          ...
          <CollapsibleContent>
            <CardContent className="flex flex-col gap-2 text-sm">
              <div className="flex gap-2">
                <label htmlFor="mechanical_seal_api_plan" className="w-[200px]">
                  API Plan
                </label>
                <Input
                  id="mechanical_seal_api_plan"
                  value={pumpDetail?.mechanical_seal_api_plan ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  id="mech_main_temp"
                  value={pumpDetail?.mech_main_temp ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="mech_main_pre" className="w-[200px]">
                  Main Pressure{" "}
                  {pumpDetail?.mech_main_pre_unit
                    ? `(${pumpDetail.mech_main_pre_unit})`
                    : ""}
                </label>
                <Input
                  id="mech_main_pre"
                  value={pumpDetail?.mech_main_pre ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  id="shaft_seal_brand"
                  value={pumpDetail?.shaft_seal_brand ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="shaft_seal_model" className="w-[200px]">
                  Shaft Seal Model
                </label>
                <Input
                  id="shaft_seal_model"
                  value={pumpDetail?.shaft_seal_model ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="mech_size" className="w-[200px]">
                  ...
                  {pumpDetail?.mech_size_unit
                    ? `(${pumpDetail.mech_size_unit})`
                    : ""}
                </label>
                <Input
                  id="mech_size"
                  value={pumpDetail?.mech_size ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.shaft_seal_design ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="shaft_seal_material" className="w-[200px]">
                  Shaft Seal Material
                </label>
                <Input
                  id="shaft_seal_material"
                  value={pumpDetail?.shaft_seal_material ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
            ...
            <CardContent className="flex flex-col gap-2 text-sm">
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.pump_suction_size ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.pump_suction_rating ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.pump_discharge_size ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.pump_discharge_rating ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.suction_pipe_size ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  id="suction_pipe_sch"
                  value={pumpDetail?.suction_pipe_sch ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="suction_pipe_id" className="w-[200px]">
                  Suction Pipe Inner Diameter{" "}
                  {pumpDetail?.suction_pipe_id_unit
                    ? `(${pumpDetail.suction_pipe_id_unit})`
                    : ""}
                </label>
                <Input
                  id="suction_pipe_id"
                  value={pumpDetail?.suction_pipe_id ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.discharge_pipe_size ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.discharge_pipe_sch ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="discharge_pipe_id" className="w-[200px]">
                  Discharge Pipe Inner Diameter{" "}
                  {pumpDetail?.discharge_pipe_id_unit
                    ? `(${pumpDetail.discharge_pipe_id_unit})`
                    : ""}
                </label>
                <Input
                  id="discharge_pipe_id"
                  value={pumpDetail?.discharge_pipe_id ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
            ...
            <CardContent className="flex flex-col gap-2 text-sm">
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.bearing_lubric_type ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.bearing_lubric_brand ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  value={pumpDetail?.bearing_lubric_no ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  id="bearing_nde_one"
                  value={pumpDetail?.bearing_nde_one ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  id="bearing_nde_two"
                  value={pumpDetail?.bearing_nde_two ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Input
                  id="bearing_de_one"
                  value={pumpDetail?.bearing_de_one ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                ...
                <Input
                  id="bearing_de_two"
                  value={pumpDetail?.bearing_de_two ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
              <div className="flex gap-2">
                <label htmlFor="bearing_last_chg_dt" className="w-[200px]">
                  Last Bearing Change Date
                </label>
                <Input
                  id="bearing_last_chg_dt"
                  value={pumpDetail?.bearing_last_chg_dt ?? ""}
                  className="h-6"
                  readOnly
                />
              </div>
